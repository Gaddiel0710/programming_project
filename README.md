...
## _Proyecto de programacion avanzada en python_

Objective: Collect each of the lessons learned throughout the period of the advanced programming class in python.

# _Explanation of the code_
## libraries used
``` Python
import msvcrt as ms #libreria para interactuar con la biblioteca de tiempo de ejecución
import time as ti #libreria para la medición y manipulación del tiempo
import os # libreria para interactuar con la pantalla de comando CMD
import math as ma #libreria para poder realizar cálculos numéricos más avanzados

from colorama import Back, Fore, Style, init #libreria que permite interactuar con las fuentes de color utilizados en la ventana de comandos CMD
init(autoreset=True)
```
## Functions
### Principal function

_main execution function, in this function you can find the menu with the different calculations or operations that can be carried out in the project_
...
_The sign up function allows registered users to enter the program, as well as help them recover their passwords if they forget them_
...
_the repeat function allows the user to repeat some action, calculation or operation_
...
_the welcome function is an animation in which the user is welcomed to the project_
...
_an animation of the credits is shown to publicize the creator of the program_
...
_function that dismisses and ends the program, a thank you animation is performed_
...
_An animation is presented in which the resolution of the gear ratio calculations used in the automation project is explained step by step_
...
_within this function the user is allowed to enter the data he wishes to use as well as select the required information_
...
_in this function all the necessary calculations are made to obtain the results of the entered data_
...
## Rate of change of a variable with respect to time
### Funtion data proyect
...
_the user is allowed to enter new data to be able to perform the calculations_
...
_Within this function, the calculations of the rate of change of the temperature variable with respect to time are performed_
...
### Function conditional menu

_function conditional to the main menu that will receive a selection regarding the calculation you want to visit_
...
# functions assigned to the main program
## functions for calculating 4 and 5 band resistors
### band color function

_in this function the user selects the color of the first 2 or 3 bands that represents the numerical value_
...
__in this function the user selects the color of the resistance multiplier band__
...
__in this function the user selects the color of the resistance tolerance band__
...
### function resistive calculation

_the resistive level of the resistance of the selected colors is calculated_
...
_conditional function to select the type of resistance to calculate_
...
## bearing life functions
### data function
_function in which the required data is added_
```Python
def GZF_datos(): 
...
### function table of ball bearings

_in this function the user selects the type of ball bearing with which he wishes to work_
...
### roller bearing table function

_in this function the user selects the type of roller bearing with which he wishes to work_
...
### service factor function

_en esta funcion el usuario selecciona el factor de servicio que recibe el cojinete_
...
### nominal life calculation function

_in this function the corresponding calculations are made to obtain the nominal life of a bearing in millions of revolutions and in hours of life_
...
_conditional menu for selecting the type of bearing with which you want to work balls or rollers_
